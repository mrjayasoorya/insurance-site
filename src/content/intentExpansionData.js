...
export const intentExpansionPages = {
  ...
  "best-insurance-agent-chennai": {
    ...
    faqs: [
      ...
      { q: "Do you serve all of Chennai?", a: "Yes. Our physical office is in Sholavaram, but we serve all Chennai — North, South, Central, and West — plus Tamil Nadu industrial belts. Most work is handled via WhatsApp and phone." },
  ...
  "trusted-insurance-services-chennai": {
    ...
    faqs: [
      { q: "How do I verify that this is a genuine IRDAI licensed agent?", a: "Our IRDAI license number is verifiable on the official IRDAI website. We display it on our office and communications. You can also check our Google Business Profile for verified business status." },
